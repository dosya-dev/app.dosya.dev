 ...
 * apps/desktop/scripts/build-reader.mjs. The reader page itself is shared with
...
const result = await build({
  entryPoints: [join(root, "src/lib/reader/reader-page/main.js")],
  bundle: true,
  format: "iife",
  target: "es2020",
  minify: true,
...
const outDir = join(root, "public/reader");
...
console.log(`web reader assets written (public/reader, ${(js.length / 1024).toFixed(0)} KB)`);
