/* eslint-disable */
// @generated by scripts/gen-validation-policy.mjs - DO NOT EDIT.
//
// Source of truth: packages/shared/src/validation/policy.ts
// Edit that file, then run:  node scripts/gen-validation-policy.mjs
//
// A one-sided edit here is caught by the validation-policy-sync suite in
// scripts/test-all.mjs, which runs this script with --check.
