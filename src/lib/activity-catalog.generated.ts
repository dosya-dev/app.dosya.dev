/* eslint-disable */
// @generated by scripts/gen-activity-catalog.mjs - DO NOT EDIT.
//
// Source of truth: packages/shared/src/activity/catalog.ts
// Edit that file, then run:  node scripts/gen-activity-catalog.mjs
//
// A one-sided edit here is caught by the activity-catalog-sync suite in
