          ...
          <Card>
            <CardContent className="pt-8 pb-6">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="relative">
                  <Button variant="outline" className="w-full h-11 text-sm font-medium gap-2 bg-primary text-primary-foreground hover:bg-primary/90" onClick={handleGithub} type="button">
